...
TEST(SearchTest, SearchTestForMaxCount) {
	...
	EmployeeInformation employee3{ 1017028552, "Donghyuk", "Jang", CareerLevel::CL2, 1212, 7949 , 1992,12,26, CertiLevel::EX };
	EmployeeInformation employee4{ 1011028552, "Donghyuk", "Jang", CareerLevel::CL2, 1212, 7949 , 1992,12,26, CertiLevel::EX };
	EmployeeInformation employee5{ 1012028552, "Donghyuk", "Jang", CareerLevel::CL2, 1212, 7949 , 1992,12,26, CertiLevel::EX };
	EmployeeInformation employee6{ 1015028552, "Donghyuk", "Jang", CareerLevel::CL2, 1212, 7949 , 1992,12,26, CertiLevel::EX };
	EmployeeInformation employee7{ 1016028552, "Donghyuk", "Jang", CareerLevel::CL2, 1212, 7949 , 1992,12,26, CertiLevel::EX };
	EmployeeInformation employee8{ 80123356, "Donghyuk", "Jang", CareerLevel::CL2, 1212, 7949 , 1992,12,26, CertiLevel::EX };
	...
	addDataForTest(employee4);
	addDataForTest(employee5);
	addDataForTest(employee6);
	addDataForTest(employee7);
	addDataForTest(employee8);

	WHEN("검색을 했을 때");

	result = searchManager.SearchEmployeeName(TestDataMap, searchEmployeeInfo);

	EXPECT_EQ(ResultData, result.size());
}